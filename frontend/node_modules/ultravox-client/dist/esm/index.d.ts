...
export declare enum AgentReaction {
    SPEAKS = "speaks",
    LISTENS = "listens",
...
export declare class Transcript {
    ...
    constructor(text: string, isFinal: boolean, speaker: Role, medium: Medium, ordinal: number);
}
...
export declare class UltravoxVideoTrackSubscribedEvent extends Event {
...
export declare class UltravoxSession extends EventTarget {
    ...
    private readonly additionalMessages;
    private _isMicMuted;
